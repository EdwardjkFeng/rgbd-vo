...
class ICP_Odometry:
    ...
    def track(self, rgb0, dpt0, rgb1, dpt1, K, vis_pcd=True, odo_init=None):
        ...
        # point-to-plane ICP
            ...
            reg_p2l = o3d_pl.registration.registration_icp(
                pcd_0,
                pcd_1,
                0.4,
                odo_init,
                o3d_pl.registration.TransformationEstimationPointToPlane(),
                o3d_pl.registration.ICPConvergenceCriteria(
            ...
            for scale in range(3):
                ...
                if self.mode == "Iter_Point2Plane":
                    result_icp = o3d_pl.registration.registration_icp(
                        pcd0_down,
                        pcd1_down,
                        radius,
                        T_10,
                    ...
                    # colored ICP
                    result_icp = o3d_pl.registration.registration_colored_icp(
                        pcd0_down,
                        pcd1_down,
                        radius * 2,
                        T_10,
                        o3d_pl.registration.TransformationEstimationForColoredICP(),
                        o3d_pl.registration.ICPConvergenceCriteria(
                            relative_fitness=1e-6,
                            relative_rmse=1e-6,
                            max_iteration=iter,
